...
/*public void SendEmail(String email,)
{
    ...
    public static ClientResponse SendContributor(String email,String hash1,String hash2) {
        Client client = ClientBuilder.newClient();
        client.register(HttpAuthenticationFeature.basic(
            "api",
            "key-2146143b75b920c2a85df48a75427f49"
        ...
        WebTarget mgRoot = client.target("https://api.mailgun.net/v3");
        //String text = "http://codeist.mi43ujva9v.us-west-2.elasticbeanstalk.com/webapi/user/verifier/"+hash1+"/"+hash2;
        String textyes = "http://localhost:8080/Codeist/webapi/user/contributorverifier/"+hash1;
        String textno = "http://localhost:8080/Codeist/webapi/user/contributorverifier/"+hash2;
        
        Form reqData = new Form();
        reqData.param("from", "Siddhartha <sid@javacrunch.in>");
        reqData.param("to",email);
        reqData.param("subject", "Add as Contributor");
        reqData.param("text", textyes+"/n"+textno);
